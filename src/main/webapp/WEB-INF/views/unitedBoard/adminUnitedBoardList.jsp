...
<head>
	...
	$(document).ready(function(){
		...
		$("#searchBtn").click(function(){
			var frm = $("#listfrm")[0];
			if($("#searchWrd1").val() == ""){
				location.href="/unitedBoard/unitedBoardList.do";
			}else{
...
<body>
	<div class="container">
		...
		<div class="form-group pull-right">
			<form:select id="searchCnd3" class="form-control" path="searchCnd3" onchange="changeBoard(this)">
				<form:option value="">전체</form:option>
				<c:forEach var="item" items="${boardTypeList}" varStatus="status">
					<form:option value="${item.idx}"><c:out value="${item.boardTypeName}" /></form:option>
				</c:forEach>
			</form:select>
